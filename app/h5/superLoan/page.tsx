    ...
    return (
        <div className="overflow-hidden min-h-screen p-4 pb-10 bg-[#f7f7f7] bg-no-repeat bg-cover flex flex-col justify-between">
            <div>
                ...
                <div className="overflow-hidden rounded-[0.32rem] mt-[0.373rem] bg-gradient-to-b from-[#ebeef8] to-[#ffffff] bg-opacity-15 p-5">
                    <img src="/images/product-container-title.png" className='w-[80%] mx-auto' />
                </div>

            </div>
            <Link href="/h5/download">
                <img src="/images/download-button-image-new.png" className='w-full cursor-pointer' />
            </Link>
